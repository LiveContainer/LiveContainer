...
@AppStorage("LCDisableInternetForGuestApps", store: LCUtils.appGroupUserDefault) var disableInternetForGuestApps = false
...
var body: some View {
    NavigationView {
        Form {
            ...
            Section {
                Toggle(isOn: $disableInternetForGuestApps) {
                    Text("Disable Internet for Guest Apps")
                }
            } footer: {
                Text("When enabled, all guest apps will be blocked from accessing the internet. This does not affect LiveContainer itself.")
            }
